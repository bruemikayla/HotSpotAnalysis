...
Adapted from Leary 2023: https://rpubs.com/heatherleeleary/hotspot_getisOrd_tut
---
...
``` {r Load Data}
HMALL <- read.csv("C:/Users/watts/OneDrive - East Carolina University/Thesis/CSV files for R/HeavyMetalsALLBDL.csv") #Should be all heavy metal data
Points <- read.csv("C:/Users/watts/OneDrive - East Carolina University/Thesis/CSV files for R/SamplingPointsAll.csv") #Should be sampling longitude and latitude points
```

```{ r Combine data and ensure numeric qualities}
HM_sf <- st_as_sf(
  HMALL,
